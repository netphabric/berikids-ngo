...
const css$2 = {
  code: '.header.svelte-1edoyyt.svelte-1edoyyt{padding:32px;margin-block-end:64px;backdrop-filter:blur(20px);background-color:rgba(242, 242, 242, 0.6352941176);position:sticky;z-index:100;top:0}.header.svelte-1edoyyt .logo.svelte-1edoyyt{color:#2b4f81}.header.svelte-1edoyyt .logo a.svelte-1edoyyt{font-family:"Aldrich", serif;font-style:normal;font-size:18px;font-weight:200;text-decoration:none;display:flex;align-items:center;gap:4px}.header.svelte-1edoyyt .nav-wrapper.svelte-1edoyyt{max-width:1440px;margin-inline:auto;display:flex;justify-content:space-between;align-items:center}.header.svelte-1edoyyt .nav-wrapper .menu.svelte-1edoyyt{display:none;cursor:pointer}.header.svelte-1edoyyt .nav-wrapper .navLinks.svelte-1edoyyt{display:flex;align-items:center;list-style:none;gap:32px}.header.svelte-1edoyyt .nav-wrapper .navLinks .navLink.svelte-1edoyyt{cursor:pointer;font-weight:500;text-transform:uppercase}',
  map: '{"version":3,"file":"header.svelte","sources":["header.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { slide } from \\"svelte/transition\\";\\nimport { cubicOut } from \\"svelte/easing\\";\\nimport Button from \\"./button.svelte\\";\\nconst navLinks = [\\n    { label: \\"about\\", url: \\"/about\\" },\\n    { label: \\"projects\\", url: \\"/projects\\" },\\n    { label: \\"Vocation\\", url: \\"/vocation\\" },\\n    { label: \\"contact\\", url: \\"contact\\" }\\n];\\nlet navOpen = false;\\nconst toggleNav = () => (navOpen = !navOpen);\\n<\/script>\\n\\n<header class=\\"header\\">\\n\\t<div class=\\"nav-wrapper\\">\\n\\t\\t<span\\n\\t\\t\\trole=\\"button\\"\\n\\t\\t\\ttabindex=\\"0\\"\\n\\t\\t\\ton:keypress={toggleNav}\\n\\t\\t\\ton:click={toggleNav}\\n\\t\\t\\tclass:menu={!navOpen}\\n\\t\\t\\tclass=\\"material-symbols-sharp\\">widgets</span\\n\\t\\t>\\n\\n\\t\\t{#if navOpen}\\n\\t\\t\\t<nav\\n\\t\\t\\t\\tclass=\\"mobileNav\\"\\n\\t\\t\\t\\tclass:open={navOpen}\\n\\t\\t\\t\\ttransition:slide={{ duration: 100, easing: cubicOut }}\\n\\t\\t\\t>\\n\\t\\t\\t\\t<ul class=\\"navLinks\\">\\n\\t\\t\\t\\t\\t{#each navLinks as { label, url }}\\n\\t\\t\\t\\t\\t\\t<li class=\\"navLink\\"><a class=\\"navHref\\" href={url} on:click={toggleNav}>{label}</a></li>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t</ul>\\n\\t\\t\\t</nav>\\n\\t\\t{/if}\\n\\n\\t\\t<div class=\\"nav-right\\">\\n\\t\\t\\t<nav class=\\"desktopNav\\">\\n\\t\\t\\t\\t<ul class=\\"navLinks\\">\\n\\t\\t\\t\\t\\t<h3 class=\\"logo\\">\\n\\t\\t\\t\\t\\t\\t<a href=\\"/\\">\\n\\t\\t\\t\\t\\t\\t\\t<span class=\\"material-symbols-sharp\\">beach_access</span>\\n\\t\\t\\t\\t\\t\\t\\t<span>BERIKIDS</span>\\n\\t\\t\\t\\t\\t\\t</a>\\n\\t\\t\\t\\t\\t</h3>\\n\\n\\t\\t\\t\\t\\t{#each navLinks as { label, url }}\\n\\t\\t\\t\\t\\t\\t<li class=\\"navLink\\"><a class=\\"navHref\\" href={url}>{label}</a></li>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t</ul>\\n\\t\\t\\t</nav>\\n\\t\\t</div>\\n\\n\\t\\t<Button>\\n\\t\\t\\t<span class=\\"material-symbols-sharp\\"> account_balance_wallet </span>\\n\\t\\t\\t<span>donate</span>\\n\\t\\t</Button>\\n\\t</div>\\n</header>\\n\\n<style lang=\\"scss\\">.header {\\n  padding: 32px;\\n  margin-block-end: 64px;\\n  backdrop-filter: blur(20px);\\n  background-color: rgba(242, 242, 242, 0.6352941176);\\n  position: sticky;\\n  z-index: 100;\\n  top: 0;\\n}\\n.header .logo {\\n  color: #2b4f81;\\n}\\n.header .logo a {\\n  font-family: \\"Aldrich\\", serif;\\n  font-style: normal;\\n  font-size: 18px;\\n  font-weight: 200;\\n  text-decoration: none;\\n  display: flex;\\n  align-items: center;\\n  gap: 4px;\\n}\\n.header .nav-wrapper {\\n  max-width: 1440px;\\n  margin-inline: auto;\\n  display: flex;\\n  justify-content: space-between;\\n  align-items: center;\\n}\\n.header .nav-wrapper .menu {\\n  display: none;\\n  cursor: pointer;\\n}\\n.header .nav-wrapper .navLinks {\\n  display: flex;\\n  align-items: center;\\n  list-style: none;\\n  gap: 32px;\\n}\\n.header .nav-wrapper .navLinks .navLink {\\n  cursor: pointer;\\n  font-weight: 500;\\n  text-transform: uppercase;\\n}</style>\\n"],"names":[],"mappings":"AA8DmB,qCAAQ,CACzB,OAAO,CAAE,IAAI,CACb,gBAAgB,CAAE,IAAI,CACtB,eAAe,CAAE,KAAK,IAAI,CAAC,CAC3B,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,YAAY,CAAC,CACnD,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,GAAG,CACZ,GAAG,CAAE,CACP,CACA,sBAAO,CAAC,oBAAM,CACZ,KAAK,CAAE,OACT,CACA,sBAAO,CAAC,KAAK,CAAC,gBAAE,CACd,WAAW,CAAE,SAAS,CAAC,CAAC,KAAK,CAC7B,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,GACP,CACA,sBAAO,CAAC,2BAAa,CACnB,SAAS,CAAE,MAAM,CACjB,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MACf,CACA,sBAAO,CAAC,YAAY,CAAC,oBAAM,CACzB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,OACV,CACA,sBAAO,CAAC,YAAY,CAAC,wBAAU,CAC7B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,CAChB,GAAG,CAAE,IACP,CACA,sBAAO,CAAC,YAAY,CAAC,SAAS,CAAC,uBAAS,CACtC,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,SAClB"}'
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="header svelte-1edoyyt"><div class="nav-wrapper svelte-1edoyyt"><span role="button" tabindex="0" class="${["material-symbols-sharp svelte-1edoyyt", "menu"].join(" ").trim()}" data-svelte-h="svelte-1yhx2sr">widgets</span> ${``} <div class="nav-right"><nav class="desktopNav"><ul class="navLinks svelte-1edoyyt"><h3 class="logo svelte-1edoyyt" data-svelte-h="svelte-i7152f"><a href="/" class="svelte-1edoyyt"><span class="material-symbols-sharp">beach_access</span> <span>BERIKIDS</span></a></h3> ${each(navLinks, ({ label, url }) => {
    return `<li class="navLink svelte-1edoyyt"><a class="navHref svelte-1edoyyt"${add_attribute("href", url, 0)}>${escape(label)}</a></li>`;
