...
const Team = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_teams();
  return `<section class="our-team svelte-1oh92uv"><div class="team-wrapper svelte-1oh92uv">${validate_component(Chip, "Chip").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} <div class="header svelte-1oh92uv" data-svelte-h="svelte-dthp7d"><h2 class="title svelte-1oh92uv">our team</h2> <p class="desc svelte-1oh92uv">dedicated professionals committed to making a difference.</p></div> <div class="teams svelte-1oh92uv">${each($teams, (team) => {
    return `<article class="member-card svelte-1oh92uv"><div class="imageContainer svelte-1oh92uv"><img${add_attribute("src", team.profile, 0)} alt="profile" class="svelte-1oh92uv"></div> <div class="content"><div class="member-details svelte-1oh92uv"><h3 class="title svelte-1oh92uv">${escape(team.name)}</h3> <p class="sub-title svelte-1oh92uv">${escape(team.role)}</p></div> <div class="member-socials"></div></div> </article>`;
  })}</div></div> </section>`;
});
