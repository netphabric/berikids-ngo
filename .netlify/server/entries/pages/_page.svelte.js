...
const Testimonials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  <section class="testimonialsSection svelte-1jnvveh"><div class="testimony-wrapper svelte-1jnvveh">${validate_component(Chip, "Chip").$$render(
    $$result,
    {
      chipText: "Testimony",
      chipIcon: "mic",
...
const ContactDetails = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<section class="contact-details svelte-ff328n"><div class="contact-details-wrapper svelte-ff328n">${validate_component(Chip, "Chip").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} <div class="contact-cards-wrapper svelte-ff328n">${each(details, (detail) => {
    return `<article class="contact-card svelte-ff328n"><span class="material-symbols-sharp contact-icon svelte-ff328n">${escape(detail.icon)}</span> <h4 class="contact-title svelte-ff328n">${escape(detail.label)}</h4> <span class="contact svelte-ff328n">${escape(detail.contact)}</span> </article>`;
  })}</div></div> </section>`;
});
