...
const css = {
  code: ".faqs-root.svelte-1c47nhj.svelte-1c47nhj{padding:32px 20px}.faqs-root.svelte-1c47nhj .faq-wrapper.svelte-1c47nhj{max-width:1440px;margin-inline:auto;display:flex;flex-direction:column;gap:32px}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header.svelte-1c47nhj{display:flex;flex-direction:column;margin-block-start:32px;gap:16px}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header .faq-title.svelte-1c47nhj{font-size:28px;font-weight:500}@media(min-width: 768px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header .faq-title.svelte-1c47nhj{font-size:32px;line-height:40px}}@media(min-width: 1024px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header .faq-title.svelte-1c47nhj{font-size:52px}}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header .faq-desc.svelte-1c47nhj{font-size:16px;font-weight:400;opacity:0.6}@media(min-width: 768px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-header .faq-desc.svelte-1c47nhj{line-height:32px;font-size:18px}}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container.svelte-1c47nhj{display:flex;flex-direction:column;border-radius:16px}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq.svelte-1c47nhj{display:flex;flex-direction:column;box-shadow:rgba(0, 0, 0, 0.1) 0px 4px 12px}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .faq-question.svelte-1c47nhj{display:flex;justify-content:space-between;align-items:center;cursor:pointer;font-size:16px;color:inherit;padding:8px 16px;border:transparent;background:transparent}@media(min-width: 768px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .faq-question.svelte-1c47nhj{font-size:18px;line-height:32px;padding:16px 32px}}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .faq-question .faq-icon.svelte-1c47nhj{display:grid;place-items:center}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .faq-question .faq-icon span.svelte-1c47nhj{font-size:16px}@media(min-width: 768px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .faq-question .faq-icon span.svelte-1c47nhj{font-size:24px}}.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .answer.svelte-1c47nhj{padding:20px;font-size:14px;font-weight:400;opacity:0.5}@media(min-width: 768px){.faqs-root.svelte-1c47nhj .faq-wrapper .faq-container .faq .answer.svelte-1c47nhj{font-size:16px;line-height:32px}}",
  map: '{"version":3,"file":"faq.svelte","sources":["faq.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { slide } from \\"svelte/transition\\";\\nimport { cubicOut } from \\"svelte/easing\\";\\nimport Chip from \\"$lib/components/chip.svelte\\";\\nexport let desc = \\"\\";\\nexport let faqs = [];\\nconst handleShowFaqAns = (id) => {\\n    faqs.forEach((faq) => {\\n        if (faq.id !== id)\\n            faq.isOpen = false;\\n    });\\n    const faq = faqs.findIndex((faq) => faq.id === id);\\n    faqs[faq].isOpen = !faqs[faq].isOpen;\\n};\\n<\/script>\\n\\n<section class=\\"faqs-root\\" id=\\"faqs\\">\\n\\t<div class=\\"faq-wrapper\\">\\n\\t\\t<Chip chipText=\\"most asked\\" chipIcon=\\"help\\" chipColor=\\"blue\\" />\\n\\t\\t<div class=\\"faq-header\\">\\n\\t\\t\\t<h2 class=\\"faq-title\\">FAQs</h2>\\n\\t\\t\\t<p class=\\"faq-desc\\">{desc}</p>\\n\\t\\t</div>\\n\\n\\t\\t<div class=\\"faq-container\\">\\n\\t\\t\\t{#each faqs as faq}\\n\\t\\t\\t\\t<article class=\\"faq\\">\\n\\t\\t\\t\\t\\t<button class=\\"faq-question\\" on:click={() => handleShowFaqAns(faq.id)}>\\n\\t\\t\\t\\t\\t\\t<span>{faq.question}</span>\\n\\n\\t\\t\\t\\t\\t\\t<div class=\\"faq-icon\\">\\n\\t\\t\\t\\t\\t\\t\\t<span class=\\"material-symbols-sharp\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t>{faq.isOpen ? \\"keyboard_arrow_up\\" : \\"keyboard_arrow_down\\"}</span\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t</button>\\n\\n\\t\\t\\t\\t\\t{#if faq.isOpen}\\n\\t\\t\\t\\t\\t\\t<p class=\\"answer\\" transition:slide={{ duration: 100, easing: cubicOut }}>\\n\\t\\t\\t\\t\\t\\t\\t{faq.ans}\\n\\t\\t\\t\\t\\t\\t</p>\\n\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t</article>\\n\\t\\t\\t{/each}\\n\\t\\t</div>\\n\\t</div>\\n</section>\\n\\n<style lang=\\"scss\\">.faqs-root {\\n  padding: 32px 20px;\\n}\\n.faqs-root .faq-wrapper {\\n  max-width: 1440px;\\n  margin-inline: auto;\\n  display: flex;\\n  flex-direction: column;\\n  gap: 32px;\\n}\\n.faqs-root .faq-wrapper .faq-header {\\n  display: flex;\\n  flex-direction: column;\\n  margin-block-start: 32px;\\n  gap: 16px;\\n}\\n.faqs-root .faq-wrapper .faq-header .faq-title {\\n  font-size: 28px;\\n  font-weight: 500;\\n}\\n@media (min-width: 768px) {\\n  .faqs-root .faq-wrapper .faq-header .faq-title {\\n    font-size: 32px;\\n    line-height: 40px;\\n  }\\n}\\n@media (min-width: 1024px) {\\n  .faqs-root .faq-wrapper .faq-header .faq-title {\\n    font-size: 52px;\\n  }\\n}\\n.faqs-root .faq-wrapper .faq-header .faq-desc {\\n  font-size: 16px;\\n  font-weight: 400;\\n  opacity: 0.6;\\n}\\n@media (min-width: 768px) {\\n  .faqs-root .faq-wrapper .faq-header .faq-desc {\\n    line-height: 32px;\\n    font-size: 18px;\\n  }\\n}\\n.faqs-root .faq-wrapper .faq-container {\\n  display: flex;\\n  flex-direction: column;\\n  border-radius: 16px;\\n}\\n.faqs-root .faq-wrapper .faq-container .faq {\\n  display: flex;\\n  flex-direction: column;\\n  box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px;\\n}\\n.faqs-root .faq-wrapper .faq-container .faq .faq-question {\\n  display: flex;\\n  justify-content: space-between;\\n  align-items: center;\\n  cursor: pointer;\\n  font-size: 16px;\\n  color: inherit;\\n  padding: 8px 16px;\\n  border: transparent;\\n  background: transparent;\\n}\\n@media (min-width: 768px) {\\n  .faqs-root .faq-wrapper .faq-container .faq .faq-question {\\n    font-size: 18px;\\n    line-height: 32px;\\n    padding: 16px 32px;\\n  }\\n}\\n.faqs-root .faq-wrapper .faq-container .faq .faq-question .faq-icon {\\n  display: grid;\\n  place-items: center;\\n}\\n.faqs-root .faq-wrapper .faq-container .faq .faq-question .faq-icon span {\\n  font-size: 16px;\\n}\\n@media (min-width: 768px) {\\n  .faqs-root .faq-wrapper .faq-container .faq .faq-question .faq-icon span {\\n    font-size: 24px;\\n  }\\n}\\n.faqs-root .faq-wrapper .faq-container .faq .answer {\\n  padding: 20px;\\n  font-size: 14px;\\n  font-weight: 400;\\n  opacity: 0.5;\\n}\\n@media (min-width: 768px) {\\n  .faqs-root .faq-wrapper .faq-container .faq .answer {\\n    font-size: 16px;\\n    line-height: 32px;\\n  }\\n}</style>\\n"],"names":[],"mappings":"AA+CmB,wCAAW,CAC5B,OAAO,CAAE,IAAI,CAAC,IAChB,CACA,yBAAU,CAAC,2BAAa,CACtB,SAAS,CAAE,MAAM,CACjB,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IACP,CACA,yBAAU,CAAC,YAAY,CAAC,0BAAY,CAClC,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,kBAAkB,CAAE,IAAI,CACxB,GAAG,CAAE,IACP,CACA,yBAAU,CAAC,YAAY,CAAC,WAAW,CAAC,yBAAW,CAC7C,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GACf,CACA,MAAO,YAAY,KAAK,CAAE,CACxB,yBAAU,CAAC,YAAY,CAAC,WAAW,CAAC,yBAAW,CAC7C,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IACf,CACF,CACA,MAAO,YAAY,MAAM,CAAE,CACzB,yBAAU,CAAC,YAAY,CAAC,WAAW,CAAC,yBAAW,CAC7C,SAAS,CAAE,IACb,CACF,CACA,yBAAU,CAAC,YAAY,CAAC,WAAW,CAAC,wBAAU,CAC5C,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,GACX,CACA,MAAO,YAAY,KAAK,CAAE,CACxB,yBAAU,CAAC,YAAY,CAAC,WAAW,CAAC,wBAAU,CAC5C,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IACb,CACF,CACA,yBAAU,CAAC,YAAY,CAAC,6BAAe,CACrC,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,aAAa,CAAE,IACjB,CACA,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,mBAAK,CAC1C,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,IACzC,CACA,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,4BAAc,CACxD,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,OAAO,CACf,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,MAAM,CAAE,WAAW,CACnB,UAAU,CAAE,WACd,CACA,MAAO,YAAY,KAAK,CAAE,CACxB,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,4BAAc,CACxD,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,OAAO,CAAE,IAAI,CAAC,IAChB,CACF,CACA,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,aAAa,CAAC,wBAAU,CAClE,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MACf,CACA,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,aAAa,CAAC,SAAS,CAAC,mBAAK,CACvE,SAAS,CAAE,IACb,CACA,MAAO,YAAY,KAAK,CAAE,CACxB,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,aAAa,CAAC,SAAS,CAAC,mBAAK,CACvE,SAAS,CAAE,IACb,CACF,CACA,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,sBAAQ,CAClD,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,GACX,CACA,MAAO,YAAY,KAAK,CAAE,CACxB,yBAAU,CAAC,YAAY,CAAC,cAAc,CAAC,IAAI,CAAC,sBAAQ,CAClD,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IACf,CACF"}'
};
const Faq = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<section class="faqs-root svelte-1c47nhj" id="faqs"><div class="faq-wrapper svelte-1c47nhj">${validate_component(Chip, "Chip").$$render(
    $$result,
    {
      chipText: "most asked",
      chipIcon: "help",
    ...
    {},
    {}
  )} <div class="faq-header svelte-1c47nhj"><h2 class="faq-title svelte-1c47nhj" data-svelte-h="svelte-1obou9r">FAQs</h2> <p class="faq-desc svelte-1c47nhj">${escape(desc)}</p></div> <div class="faq-container svelte-1c47nhj">${each(faqs, (faq) => {
    return `<article class="faq svelte-1c47nhj"><button class="faq-question svelte-1c47nhj"><span class="svelte-1c47nhj">${escape(faq.question)}</span> <div class="faq-icon svelte-1c47nhj"><span class="material-symbols-sharp svelte-1c47nhj">${escape(faq.isOpen ? "keyboard_arrow_up" : "keyboard_arrow_down")}</span> </div></button> ${faq.isOpen ? `<p class="answer svelte-1c47nhj">${escape(faq.ans)} </p>` : ``} </article>`;
  })}</div></div> </section>`;
});
export {
  Faq as F,
